        ...
        public static Template MainMenuExampleLabel1
        {
            get
            {
...
#endif
                {
                    ...
                    Delight.Label.FontSizeProperty.SetDefault(_mainMenuExampleLabel1, 40);
                    Delight.Label.FontProperty.SetDefault(_mainMenuExampleLabel1, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
...
#endif
                    Delight.Label.FontSizeProperty.SetDefault(_mainMenuExampleButton1Label, 40);
                    Delight.Label.FontProperty.SetDefault(_mainMenuExampleButton1Label, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
...
#endif
                    Delight.Label.FontSizeProperty.SetDefault(_mainMenuExampleButton2Label, 40);
                    Delight.Label.FontProperty.SetDefault(_mainMenuExampleButton2Label, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
...
#endif
                    Delight.Label.FontSizeProperty.SetDefault(_mainMenuExampleButton3Label, 40);
                    Delight.Label.FontProperty.SetDefault(_mainMenuExampleButton3Label, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
