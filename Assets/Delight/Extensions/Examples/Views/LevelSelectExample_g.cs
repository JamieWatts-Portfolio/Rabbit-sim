        ...
        public static Template LevelSelectExampleLabel1
        {
            get
            {
...
#endif
                {
                    ...
                    Delight.Label.FontSizeProperty.SetDefault(_levelSelectExampleLabel1, 50);
                    ...
                    Delight.Label.FontProperty.SetDefault(_levelSelectExampleLabel1, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
                }
...
#endif
                    Delight.Label.FontSizeProperty.SetDefault(_levelSelectExampleLabel2, 50);
                    Delight.Label.AutoSizeProperty.SetDefault(_levelSelectExampleLabel2, Delight.AutoSize.Default);
                    Delight.Label.FontProperty.SetDefault(_levelSelectExampleLabel2, Assets.Fonts["AveriaSansLibre-Bold SDF"]);
