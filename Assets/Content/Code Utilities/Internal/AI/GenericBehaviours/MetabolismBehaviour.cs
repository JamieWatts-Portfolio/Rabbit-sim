...
public class MetabolismBehaviour : MonoBehaviour
{
    public MetabolismBehaviour(){}

    public MetabolismBehaviour(byte MaxSaturation, float HungerThreshold, float MetabolismRate) {
